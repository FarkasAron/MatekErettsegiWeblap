        ...
        >
          <div className="min-h-full flex items-center justify-center p-4 sm:p-8">
            <div className="relative w-full max-w-4xl animate-fade-up" onClick={(e) => e.stopPropagation()}>
              ...
              {/* Same actions as the card footer, so the user need not close the
                  lightbox to add the problem or view its solution. */}
              <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
                {answerUrl && !answerMissing && (
                  <LightboxButton onClick={() => { setOpen(false); setAnswerOpen(true); }}>
                    Megoldás
                  </LightboxButton>
                )}
                <LightboxButton
